import { useEffect, useRef, useMemo, useState, useImperativeHandle, useCallback, Component, isValidElement, forwardRef, createRef, createContext, useContext, lazy, Suspense } from 'react';
...
const ComposerComp = (props) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className, children: [
    /* @__PURE__ */ jsxs("div", { className: "flex flex-row pl-10", children: [
      /* @__PURE__ */ jsx("div", { className: `flex w-full pl-2`, children: /* @__PURE__ */ jsx(
        "textarea",
        {
      ...
      /* @__PURE__ */ jsxs("div", { className: `flex flex-1 items-center px-2 `, children: [
        !showCancelButton && /* @__PURE__ */ jsx(
          "button",
          {
            ...
            "aria-label": "Send",
            children: /* @__PURE__ */ jsx(IoSend, { style: disableButton ? { cursor: "not-allowed" } : { cursor: "pointer" }, "aria-disabled": disableButton, color: disableButton ? "grey" : "black", size: "20" })
          }
        ),
        showCancelButton && /* @__PURE__ */ jsx(
          "button",
          {
            ...
            "aria-label": "Cancel",
            children: /* @__PURE__ */ jsx(FaRegCircleStop, { size: "20" })
          }
        )
      ] })
    ] }),
...
const LoaderComp = () => {
  return /* @__PURE__ */ jsx("div", { className: className$5, children: /* @__PURE__ */ jsx("div", { className: "nlux-comp-loaderContainer", children: /* @__PURE__ */ jsx("span", { className: "spinning-loader" }) }) });
};
...
const AiChat = function(props) {
  ...
  return /* @__PURE__ */ jsx(PrimitivesContextProvider, { children: /* @__PURE__ */ jsxs("div", { className: rootClassNames, style: rootStyle, "data-color-scheme": colorSchemeToApply, children: [
    /* @__PURE__ */ jsx("div", { className: className$6, ref: exceptionBoxRef }),
