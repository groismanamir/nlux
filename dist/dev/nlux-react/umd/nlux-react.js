(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('react/jsx-runtime'), require('react-icons/io5'), require('react-icons/fa6'), require('@nlux/core')) :
    typeof define === 'function' && define.amd ? define(['exports', 'react', 'react/jsx-runtime', 'react-icons/io5', 'react-icons/fa6', '@nlux/core'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["@nlux/react"] = {}, global.react, global.jsxRuntime, global.io5, global.fa6, global.core));
})(this, (function (exports, react, jsxRuntime, io5, fa6, core) { 'use strict';
    ...
    const className$6 = "nlux-comp-exceptionBox";
    ...
    const className$5 = "nlux-comp-messageLoader";
    ...
    const className$4 = "nlux-comp-composer";
    ...
    const ComposerComp = (props) => {
      ...
      const className = `${className$4} ${compClassNameFromStats}`;
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs("div", { className, children: [
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-row pl-10", children: [
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: `flex w-full pl-2`, children: /* @__PURE__ */ jsxRuntime.jsx(
            "textarea",
            {
          ...
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: `flex flex-1 items-center px-2 `, children: [
            !showCancelButton && /* @__PURE__ */ jsxRuntime.jsx(
              "button",
              {
                ...
                "aria-label": "Send",
                children: /* @__PURE__ */ jsxRuntime.jsx(io5.IoSend, { style: disableButton ? { cursor: "not-allowed" } : { cursor: "pointer" }, "aria-disabled": disableButton, color: disableButton ? "grey" : "black", size: "20" })
              }
            ),
            showCancelButton && /* @__PURE__ */ jsxRuntime.jsx(
              "button",
              {
                ...
                "aria-label": "Cancel",
                children: /* @__PURE__ */ jsxRuntime.jsx(fa6.FaRegCircleStop, { size: "20" })
              }
            )
          ] })
        ] }),
...
`
    ...
    const LoaderComp = () => {
      return /* @__PURE__ */ jsxRuntime.jsx("div", { className: className$5, children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: "nlux-comp-loaderContainer", children: /* @__PURE__ */ jsxRuntime.jsx("span", { className: "spinning-loader" }) }) });
    };
    ...
    const useUiOverrides = (props) => {
      ...
      const Footer = react.useMemo(() => {
        ...
        return possibleUiOverrides.find((child) => child.type === AiChatUI.Footer);
      }, [possibleUiOverrides]);
      return {
        Loader,
        Greeting,
    ...
    const AiChat = function(props) {
      ...
      return /* @__PURE__ */ jsxRuntime.jsx(PrimitivesContextProvider, { children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: rootClassNames, style: rootStyle, "data-color-scheme": colorSchemeToApply, children: [
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: className$6, ref: exceptionBoxRef }),
